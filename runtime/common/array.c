...
RML_BEGIN_LABEL(RML__array_5fadd)
{
  ...
  nelts = RML_HDRSLOTS(RML_GETHDR(vec));
  {
    ...
    vec_new = (struct rml_struct*)rml_prim_alloc(2+nelts, 2); 
    RML_CHECK_POINTER(vec_new, RML__array_5fadd, "RML.arrayAdd");
...
RML_BEGIN_LABEL(RML__array_5fcreate)
{
  ...
  nelts = RML_UNTAGFIXNUM(rmlA0);
    ...
    vec = (struct rml_struct*)rml_prim_alloc(1+nelts, 2);
    RML_CHECK_POINTER(vec, RML__array_5fcreate, "RML.arrayCreate");
...
RML_BEGIN_LABEL(RML__array_5flist)
{
    ...
    RML_CHECK_POINTER(consp, RML__array_5flist, "RML.arrayList");
    
    vecp = RML_STRUCTDATA(rmlA0) + nelts;
...
RML_BEGIN_LABEL(RML__array_5fsetnth)
{
  ...
  else 
  {
    ...
    RML_CHECK_POINTER(vec_new, RML__array_5fsetnth, "RML.arraySetNth");
...
RML_BEGIN_LABEL(RML__array_5fupdate)
{
  ...
  vec_new = (struct rml_struct*)rml_prim_alloc(1+nelts, 3);
  RML_CHECK_POINTER(vec_new, RML__array_5fupdate, "RML.arrayUpdate");
...
RML_BEGIN_LABEL(RML__array_5fvector)
{
  ...
  nelts = RML_HDRSLOTS(RML_GETHDR(vec));
  {
    ...
    vec_new = (struct rml_struct*)rml_prim_alloc(1+nelts, 1);
    RML_CHECK_POINTER(vec_new, RML__array_5fvector, "RML.arrayVector");
...
RML_BEGIN_LABEL(RML__array_5fcopy)
{
  ...
  nelts = RML_HDRSLOTS(RML_GETHDR(vec));
  {
    ...
    vec_new = (struct rml_struct*)rml_prim_alloc(1+nelts, 1);
    RML_CHECK_POINTER(vec_new, RML__array_5fcopy, "RML.arrayCopy");
