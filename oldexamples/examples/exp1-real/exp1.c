...
static const RML_DEFSTRINGLIT(lit8,32,"call:RML.real_add(v1,v2) => (v3)");
static const RML_DEFSTRINGLIT(lit9,32,"call:RML.real_mul(v1,v2) => (v3)");
static const RML_DEFSTRINGLIT(lit10,1,"e");
static const RML_DEFSTRINGLIT(lit11,20,"call:eval(e) => (v1)");
static const RML_DEFSTRINGLIT(lit12,29,"call:RML.real_neg(v1) => (v2)");
static const RML_DEFSTRINGLIT(lit13,32,"call:RML.real_div(v1,v2) => (v3)");
static const RML_DEFSTRINGLIT(lit14,32,"call:RML.real_sub(v1,v2) => (v3)");
