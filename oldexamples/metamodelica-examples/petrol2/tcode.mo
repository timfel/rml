...
uniontype Ty
  ...
  record UNFOLD
    Stamp x1 " UNFOLD and Stamp: record designator - to handle recursive records ";
  end UNFOLD;
end Ty;
...
uniontype UnOp " A number of unary conversion operators, augmented with LOAD and OFFSET "
  record CtoI
  end CtoI;
  record ItoR
  end ItoR;
...
uniontype BinOp " Typed binary operators "
  record IADD
  end IADD;
  record ISUB
  end ISUB;
