...
functor StatObjFn(
  ...
  struct
    ...
    let 
      ...
      val VE = bindRel(VE,"bool_eq",[tau_bool,tau_bool],[tau_bool])
      
      (* characters *)
      val VE = bindRel(VE,"char_int",[tau_char],[tau_int])
      val VE = bindRel(VE,"string_char_int",[tau_string],[tau_int])
      val VE = bindRel(VE,"char_eq",[tau_char,tau_char],[tau_bool])
      ...
      val VE = bindRel(VE,"list_map",[tau_alpha_list,Ty.REL([tau_alpha],[tau_beta],NONE)],[tau_beta_list])
      ...
      val VE = bindRel(VE,"string_eq",[tau_string,tau_string],[tau_bool])
      ...
      val VE = bindRel(VE,"boolEq",[tau_bool,tau_bool],[tau_bool])
      
      (* characters *)
      val VE = bindRel(VE,"charInt",[tau_char],[tau_int])
      val VE = bindRel(VE,"stringCharInt",[tau_string],[tau_int])
      val VE = bindRel(VE,"charEq",[tau_char,tau_char],[tau_bool])
      ...
      val VE = bindRel(VE,"listMap",[tau_alpha_list,Ty.REL([tau_alpha],[tau_beta],NONE)],[tau_beta_list])
      ...
      val VE = bindRel(VE,"stringEq",[tau_string,tau_string],[tau_bool])
