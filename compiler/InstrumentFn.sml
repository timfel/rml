  ...
  *)
  ...
  fun print_list_comma_pat(foo_star, print_foo) =
    ...
    *)
    ...
    fun getPatsAsString(pats) = print_parens_comma(pats, getPatAsString)
    ...
    fun getExpsAsString(exps) = print_list_comma_exp(exps, getExpAsString)
    ...
    fun instrumentClause(
      ...
      | instrumentClause(Absyn.CLAUSE2(cl1,cl2, infoCLAUSE2), relIdent) =
        Absyn.CLAUSE2(
            ...
            infoCLAUSE2)
      | instrumentClause(Absyn.CLAUSE3(cl1,cl2, infoCLAUSE2), relIdent) =
        Absyn.CLAUSE3(
            instrumentClause(cl1, relIdent), 
            instrumentClause(cl2, relIdent),
            infoCLAUSE2)
