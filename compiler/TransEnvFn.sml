...
functor TransEnvFn(structure Util : UTIL
  ...
  struct
    ...
    val tenv0 =
	  ...
	  val te = inline(te, "bool_eq", mk_binary_inliner CPS.BOOL_EQ)
	  (* options *)
	  ...
	  val te = inline(te, "char_eq", mk_binary_inliner CPS.CHAR_EQ)
	  (* string characters *)
	  ...
	  val te = inline(te, "string_equal", mk_binary_inliner CPS.STRING_EQ)
	  val te = inline(te, "string_eq", mk_binary_inliner CPS.STRING_EQ)
	  ...
	  val te = inline(te, "real_eq", mk_binary_inliner CPS.REAL_EQ)
	  ...
	  val te = inline(te, "boolEq", mk_binary_inliner CPS.BOOL_EQ)
	  (* characters *)
	  val te = inline(te, "charInt", int_int_inliner)
	  val te = inline(te, "intChar", int_int_inliner)
	  val te = inline(te, "charEq", mk_binary_inliner CPS.CHAR_EQ)
	  (* string characters *)
	  ...
	  val te = inline(te, "stringEqual", mk_binary_inliner CPS.STRING_EQ)
	  val te = inline(te, "stringEq", mk_binary_inliner CPS.STRING_EQ)	  
	  ...
	  val te = inline(te, "realEq", mk_binary_inliner CPS.REAL_EQ)
	  (* lists *)
