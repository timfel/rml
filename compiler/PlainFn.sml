...
functor PlainFn(
  ...
  structure Source  = Source
    ...
    val primINT_BIT_NOT = LABEL(Mangle.NAME "RML_PRIM_INT_BIT_NOT", ConRep.dummyLongIdent, ConRep.dummyInfo)
    val primREF_INT = LABEL(Mangle.NAME "RML_PRIM_REF_INT", ConRep.dummyLongIdent, ConRep.dummyInfo)
    val primVAL_CONSTR = LABEL(Mangle.NAME "RML_PRIM_VAL_CONSTR", ConRep.dummyLongIdent, ConRep.dummyInfo)
    val primVAL_SLOTS = LABEL(Mangle.NAME "RML_PRIM_VAL_SLOTS", ConRep.dummyLongIdent, ConRep.dummyInfo)
    val primSTRING_HASH = LABEL(Mangle.NAME "RML_PRIM_STRING_HASH", ConRep.dummyLongIdent, ConRep.dummyInfo)
    val primSTRING_HASH_DJB2 = LABEL(Mangle.NAME "RML_PRIM_STRING_HASH_DJB2", ConRep.dummyLongIdent, ConRep.dummyInfo)
    val primSTRING_HASH_SDBM = LABEL(Mangle.NAME "RML_PRIM_STRING_HASH_SDBM", ConRep.dummyLongIdent, ConRep.dummyInfo)
    ...
    val primINT_BIT_AND = LABEL(Mangle.NAME "RML_PRIM_INT_BIT_ADD", ConRep.dummyLongIdent, ConRep.dummyInfo)
    val primINT_BIT_OR = LABEL(Mangle.NAME "RML_PRIM_INT_BIT_OR", ConRep.dummyLongIdent, ConRep.dummyInfo)
    val primINT_BIT_XOR = LABEL(Mangle.NAME "RML_PRIM_INT_BIT_XOR", ConRep.dummyLongIdent, ConRep.dummyInfo)
    val primINT_BIT_LSHIFT = LABEL(Mangle.NAME "RML_PRIM_INT_BIT_LSHIFT", ConRep.dummyLongIdent, ConRep.dummyInfo)
    val primINT_BIT_RSHIFT = LABEL(Mangle.NAME "RML_PRIM_INT_BIT_RSHIFT", ConRep.dummyLongIdent, ConRep.dummyInfo)
    ...
    val primREF_EQ = LABEL(Mangle.NAME "RML_PRIM_REF_EQ", ConRep.dummyLongIdent, ConRep.dummyInfo)
    
    val primVAL_EQ = LABEL(Mangle.NAME "RML_PRIM_VAL_EQ", ConRep.dummyLongIdent, ConRep.dummyInfo)
    val primVAL_MATCH = LABEL(Mangle.NAME "RML_PRIM_VAL_MATCH", ConRep.dummyLongIdent, ConRep.dummyInfo)
